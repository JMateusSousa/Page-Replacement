...
public class Main {
	...
	public static void main(String[] args){
		...
		JTextField q1Field = new JTextField(5);
		JTextField q2Field = new JTextField(5);
		JTextField rField = new JTextField(5);

		JPanel myPanel = new JPanel();
		myPanel.add(new JLabel("Q1:"));
		myPanel.add(q1Field);
		myPanel.add(Box.createHorizontalStrut(15));
		myPanel.add(new JLabel("Q2:"));
		myPanel.add((q2Field));
		myPanel.add(Box.createHorizontalStrut(15));
		myPanel.add(new JLabel("Referência:"));
		myPanel.add(rField);

		int result = JOptionPane.showConfirmDialog(null, myPanel, "Page Replacement", JOptionPane.OK_CANCEL_OPTION);
		if(result == JOptionPane.OK_OPTION){
			System.out.println("q1 value: " + q1Field.getText());
			Q1 = Integer.parseInt(q1Field.getText());
			Q2 = Integer.parseInt(q2Field.getText());
			numReferences = Integer.parseInt(rField.getText());
		}
